...
- 2025-09-19 과거에 사람들이 상상한 미래 ✔️
  - 팀 미션 1
      ...
      -  느낀점
        : 미래의 기술을 상상해서 그림을 그리라는 요구가 어찌 보면 굉장히 어려운 요구인데 그걸 그리는 것뿐만 아니라 대부분의 그려져있는 기술들이 현재에는 실현되었다는 사실이 정말 놀라운 것 같다. 하지만 또 한편으로는 이렇게 과거에 예측을 했던 기술들이 있어서 현재 우리가 그걸 기반으로 발전을 할 수 있겠다는 생각이 들었다. 그래서 우리도 이에 미래에 실현되었으면 하는 기술들을 예측하기로 하였다. 우리의 상상 속에서 만들어진 기술들이 결국 미래에 발전될 기술들의 기반이 될 수 있으므로 우리는 상상을 멈추지 않아야 할 것 같다. 
  -  팀 미션2
      - 영상1
        - 실현된 기술: 가상의 공간에서 해외에 있는 사람과 실시간 접촉, 실시간 언어 통역 기능, 투명 모니터, 태블릿 등을 통해 그림/메모 기능, IoT서비스를 통해 집안 기기 제어 가능
      - 영상2
        -  실현된 기술 : 노트 패드, 터치스크린, 화상통화, VOD (주문형 비디오), 원격티켓예매, 첨단손목시계, 로봇 비서 '핀핀', 반려 로봇 핀핀, 사이버 가수 '아담', 스마트폰을 이용한 결제 및 인증, 로봇의사의 원격 수술, 머리에 쓰는 텔레비전
      - 영상3
